...
%                 plot(t,cum,'-.','LineWidth',4);hold on;
        ...
        elseif upsilon0==5.9e-4
            if i1==1
                ...
                figure(8);% v1, slow
                subplot(1,2,1);
                h8(2)=plot(t,100*cum/popOut,'-.','LineWidth',4,'color',col_p(1,:));hold on;
                h8(3)=plot(t,100*cumvacc/popOut,'LineWidth',4,'color',col_p(1,:));hold on;
                xlim([0,800]);
                ylim([0,25]);
            else
                figure(6);
                ...
                figure(8);% v2, slow
                subplot(1,2,2);
                h9(2)=plot(t,100*cum/popOut,'-.','LineWidth',4,'color',col_p(1,:));hold on;
                h9(3)=plot(t,100*cumvacc/popOut,'LineWidth',4,'color',col_p(1,:));hold on;
                xlim([0,800]);
                ylim([0,25]);
            end
        else
            if i1==1
                ...
                figure(9);% v1, fast
                subplot(1,2,1);
                h8(4)=plot(t,100*cum/popOut,'-.','LineWidth',4,'color',col_p(2,:));hold on;
                h8(5)=plot(t,100*cumvacc/popOut,'LineWidth',4,'color',col_p(2,:));hold on;
                xlim([0,800]);
                ylim([0,25]);
            else
                figure(6);
                ...
                figure(9);% v2, fast
                subplot(1,2,2);
                h9(4)=plot(t,100*cum/popOut,'-.','LineWidth',4,'color',col_p(2,:));hold on;
                h9(5)=plot(t,100*cumvacc/popOut,'LineWidth',4,'color',col_p(2,:));hold on;
                xlim([0,800]);
                ylim([0,25]);
            end
        end
